...
export default Joi.object({
    ...
    S3_ACCESS_KEY: Joi.string().optional().default(''),
    S3_SECRET_KEY: Joi.string().optional().default(''),
    S3_BUCKET_NAME: Joi.string().optional().default(''),
    S3_API_ENDPOINT: Joi.string().optional().default(''),
    S3_REGION: Joi.string().optional().default(''),
});
